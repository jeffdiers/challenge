 ...
 *
 */
export const useCachingFetch: UseCachingFetch = (_url) => {
  return {
    data: null,
    isLoading: false,
    error: new Error(
 ...
 *
 */
export const preloadCachingFetch = async (_url: string): Promise<void> => {
  throw new Error(
...
export const initializeCache = (_serializedCache: string): void => {};
